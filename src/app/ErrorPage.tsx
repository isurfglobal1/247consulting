...
export function ErrorPage({ error }: ErrorPageProps) {
	...
	return (
		<div className="min-h-screen bg-[#0A0A0A] relative overflow-hidden">
			...
			{/* Animated Glow Orbs */}
			<div className="absolute top-20 right-20 w-64 h-64 bg-primary-blue/10 rounded-full blur-[100px] animate-pulse" />
			<div
				className="absolute bottom-20 left-20 w-80 h-80 bg-primary-blue/5 rounded-full blur-[120px] animate-pulse"
				...
				<motion.div
					...
					<motion.div
						...
						<div className="relative">
							<div className="w-24 h-24 rounded-full bg-primary-blue/10 flex items-center justify-center">{errorIcon}</div>
							<div
					...
					{errorType !== 'client' && errorType !== 'network' && errorType !== 'unknown' && (
						<motion.div
							...
							className="text-[80px] md:text-[120px] font-heading font-black text-white/10 select-none mb-4">
							{errorType}
						</motion.div>
					)}
					...
					<motion.h1
						...
						className="text-3xl md:text-5xl font-heading font-black text-white mb-6 tracking-tight">
						{errorTitle}
					</motion.h1>
					...
					<motion.p
						...
						className="text-white/60 text-lg md:text-xl font-light leading-relaxed mb-12 max-w-xl mx-auto">
						{errorMessage}
					</motion.p>
