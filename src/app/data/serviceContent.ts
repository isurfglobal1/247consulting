...
export const servicesContent: Record<string, ServiceContent> = {
	'call-center': {
		...
		narrative: {
			...
			image:
				'https://images.unsplash.com/photo-1599776521727-e2e373e50d65?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjYWxsJTIwY2VudGVyJTIwbWluaW1hbHxlbnwxfHx8fDE3ODAwMTM1ODV8MA&ixlib=rb-4.1.0&q=80&w=1080',
		},
		features: [
	...
	'workspace': {
		...
		narrative: {
			...
			image:
				'https://images.unsplash.com/photo-1491406213019-05b162a72c20?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMGFyY2hpdGVjdHVyZSUyMG1pbmltYWx8ZW58MXx8fHwxNzgwMDEzNTg1fDA&ixlib=rb-4.1.0&q=80&w=1080',
		},
		features: [
	...
	'training': {
		...
		features: [
			{
				title: 'Immersive Learning Architecture',
				description: 'Classrooms and hubs built specifically for flow states, cognitive absorption, and collaborative friction-free thinking.',
			},
			...
			{
				title: 'Spatial Knowledge Design',
				description: 'Environments where physical space dictates intellectual expansion, breaking traditional corporate constraints.',
			},
		],
		benefits: [
	...
	'default': {
		...
		narrative: {
			...
			image:
				'https://images.unsplash.com/photo-1758611972971-1c8b9c6d7822?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhZnJpY2FuJTIwY29ycG9yYXRlJTIwd29ya3NwYWNlfGVufDF8fHx8MTc4MDAxMzU4NXww&ixlib=rb-4.1.0&q=80&w=1080',
		},
		features: [
