...
// 								<span className="text-primary-blue font-mono text-sm tracking-[0.2em] uppercase">{t('contact.heroBadge')}</span>
// 							</div>
// 							<h1 className="text-[64px] md:text-[88px] font-heading font-black text-white leading-[0.9] tracking-tighter uppercase mb-8">
// 								{t('contact.heroTitle1')} <br />
// 								<span>{t('contact.heroTitle2')}</span> {t('contact.heroTitle3')}
// 							</h1>
// 							<p className="text-2xl font-light text-white/60 max-w-2xl leading-relaxed">{t('contact.heroDescription')}</p>
// 						</motion.div>
// 					</div>
// 				</div>
// 			</section>
...
// 							transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}
// 							className="lg:col-span-7 flex flex-col">
// 							<h3 className="text-3xl font-heading font-bold text-white uppercase tracking-tight mb-16 border-b border-white/20 pb-6">
// 								{t('contact.formTitle', 'Initiate Dialogue')}
// 							</h3>
...
// 								<div className="mt-8">
// 									<button className="w-full sm:w-auto h-[64px] px-12 bg-white text-primary-black font-bold tracking-widest uppercase text-sm rounded-xl hover:bg-primary-blue hover:text-white transition-all duration-500 flex items-center justify-center gap-4 group shadow-premium-hover">
// 										{t('contact.submitButton')}
// 										<ArrowRight
// 											className="group-hover:translate-x-2 transition-transform duration-300"
// 											size={20}
...
// 									<MapPin size={20} />
// 									<span className="font-mono text-xs uppercase tracking-widest">{t('contact.hqLabel')}</span>
// 								</div>
...
// 							<div className="flex flex-col gap-6 group cursor-pointer hover:bg-white/5 -mx-8 px-8 py-6 rounded-2xl transition-all duration-500">
// 								<div className="flex items-center gap-4 text-white/40 mb-2 group-hover:text-primary-blue transition-colors duration-300">
// 									<Mail size={20} />
// 									<span className="font-mono text-xs uppercase tracking-widest">{t('contact.emailLabel')}</span>
// 								</div>
// 								<p className="text-2xl font-light text-white group-hover:text-primary-blue transition-colors duration-300">{t('contact.emailAddress')}</p>
// 							</div>

// 							<div className="flex flex-col gap-6 group cursor-pointer hover:bg-white/5 -mx-8 px-8 py-6 rounded-2xl transition-all duration-500">
// 								<div className="flex items-center gap-4 text-white/40 mb-2 group-hover:text-primary-blue transition-colors duration-300">
// 									<Phone size={20} />
// 									<span className="font-mono text-xs uppercase tracking-widest">{t('contact.phoneLabel')}</span>
// 								</div>
// 								<p className="text-2xl font-light text-white group-hover:text-primary-blue transition-colors duration-300">{t('contact.phoneNumber')}</p>
// 							</div>

// 							<div className="flex flex-col gap-6">
// 								<div className="flex items-center gap-4 text-white/40 mb-2">
// 									<Clock size={20} />
// 									<span className="font-mono text-xs uppercase tracking-widest">{t('contact.coverageLabel')}</span>
// 								</div>
...
// 						<span className="font-mono text-xs text-primary-blue uppercase tracking-widest">{t('contact.mapHubName')}</span>
// 						<span className="text-white text-sm font-medium">{t('contact.mapCoordinates')}</span>
// 					</div>
// 				</div>
// 			</section>
...
// 						<span className="text-white/70 font-mono text-xs uppercase tracking-widest">{t('contact.finalBadge')}</span>
// 					</div>
...
// 						<span className="relative z-10">{t('contact.finalButton')}</span>
// 						<ArrowUpRight
// 							size={24}
// 							className="relative z-10 group-hover:rotate-45 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-300"
// 						/>
