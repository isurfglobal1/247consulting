...
export function ServicesProcess() {
  const steps = [
    { num: "01", title: "Consultation & Architecture", desc: "Mapping the operational gaps and designing the human capital infrastructure." },
    { num: "02", title: "Talent Mapping", desc: "Algorithmic market analysis and executive target identification." },
    { num: "03", title: "Verification Protocol", desc: "Rigorous legal, credential, and behavioral vetting processes." },
    { num: "04", title: "System Deployment", desc: "Seamless integration of personnel, payroll, and compliance systems." },
    { num: "05", title: "Workforce Optimization", desc: "Continuous performance analytics and structural scaling." }
  ];
      ...
      <div className="container-enterprise relative z-10">
        ...
        >
          ...
          <h2 className="text-white text-4xl md:text-6xl font-heading font-black tracking-tight leading-[1.05]">
            The Operational Flow <br/> <span className="text-white/30">Architecture</span>
          </h2>
        </motion.div>
