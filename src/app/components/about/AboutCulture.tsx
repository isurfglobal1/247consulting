			...
			<div className="container-enterprise relative z-10">
				<motion.div
					...
					<h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-heading font-black tracking-tight mb-6 leading-[1.1]">
						{t('A Culture of')} <br /> <span className="text-primary-blue">{t('Relentless Execution')}</span>
					</h2>
					<p className="text-white/60 text-lg font-light leading-relaxed">
						{t('Behind our technology lies a team of operators who believe that human capital is the ultimate competitive advantage.')}
					</p>
				</motion.div>
				...
				<div className="grid grid-cols-1 md:grid-cols-12 grid-rows-[auto_auto] gap-6">
					...
					<motion.div
						...
						<h3 className="text-white text-3xl font-heading font-black leading-tight mb-4">{t('"We dont just hire talent. We architect teams."')}</h3>
						<p className="text-white/80 font-medium">{t('Head of Internal Operations')}</p>
					</motion.div>
					...
					<motion.div
						...
						<ImageWithFallback
							...
							alt="Modern Office Corporate Building"
