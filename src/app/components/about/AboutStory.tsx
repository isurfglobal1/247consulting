				...
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-center">
					...
					<motion.div
						...
						<h2 className="text-white text-3xl md:text-5xl font-heading font-black tracking-tight mb-10 leading-[1.1]">
							{t('Architecting the')} <br />
							<span className="text-primary-blue">{t('Continental Engine')}</span>
						</h2>
						...
						<div className="space-y-8">
							...
							<div className="p-6 rounded-2xl bg-white/5 border border-white/10 mt-8 relative overflow-hidden">
								...
								<p className="text-white text-lg font-medium italic">
									{t('"Our mandate isnt just staffing. Its building the resilient operational architecture that allows businesses to scale fearlessly."')}
								</p>
							</div>
						</div>
					</motion.div>
