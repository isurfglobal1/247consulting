			...
			<div className="container-enterprise">
				<motion.div
					...
					<div className="w-full lg:w-5/12 flex flex-col justify-between py-12">
						<div>
							<div className="text-primary-blue font-mono text-sm tracking-widest uppercase mb-8">{t('Executive Perspectives // 03')}</div>
							<h2 className="text-3xl md:text-5xl font-heading font-bold text-white leading-[1.2] tracking-tight">
								{t('"We dont manage processes. We engineer structural momentum for the entire continent."')}
							</h2>
						</div>
						...
						<div className="mt-16 flex items-center gap-6">
							...
							<div className="flex flex-col">
								<span className="text-white font-bold text-lg">{t('Amara K.')}</span>
								<span className="text-white/50 font-mono text-xs tracking-wider uppercase mt-1">{t('Head of Talent Systems')}</span>
							</div>
						</div>
					</div>
