	...
	const features = [
		{
			...
			title: t('Workforce Scalability'),
			description: t('Navigate complex African labor frameworks with dynamically updated legal intelligence and automated regulatory reporting.'),
			color: 'from-primary-blue/20 to-primary-blue/5',
		},
		{
			icon: <ShieldCheck className="text-green-400 w-6 h-6" />,
			title: t('HR Automation'),
			description: t('Encrypted, on-continent data localization ensuring absolute compliance with regional data protection directives.'),
			color: 'from-green-400/20 to-green-400/5',
		},
		{
			icon: <TrendingUp className="text-purple-400 w-6 h-6" />,
			title: t('Compliance Systems'),
			description: t('Transform raw continental workforce data into actionable, board-level strategic insights and predictive modeling.'),
			...
			<div className="container-enterprise relative z-10">
				<motion.div
					...
					<h2 className="text-white text-3xl md:text-5xl font-heading font-black tracking-tight mb-6">
						{t('Architecting the future of')} <span className="text-primary-blue">{t('African enterprise')}</span> {t('workforce management.')}
					</h2>
				</motion.div>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 relative z-10">
					...
					{features.map((feature, idx) => (
						<motion.div
							...
							<p className="text-white/50 text-sm md:text-base font-body leading-relaxed max-w-sm">{feature.description}</p>
						</motion.div>
					))}
				</div>
			</div>
...
//       description: "Navigate complex African labor frameworks with dynamically updated legal intelligence and automated regulatory reporting.",
//       color: "from-primary-blue/20 to-primary-blue/5"
//     },
//     {
//       icon: <ShieldCheck className="text-green-400 w-6 h-6" />,
//       title: "HR Automation",
//       description: "Encrypted, on-continent data localization ensuring absolute compliance with regional data protection directives.",
//       color: "from-green-400/20 to-green-400/5"
//     },
//     {
//       icon: <TrendingUp className="text-purple-400 w-6 h-6" />,
//       title: "Compliance Systems",
//       description: "Transform raw continental workforce data into actionable, board-level strategic insights and predictive modeling.",
//       color: "from-purple-400/20 to-purple-400/5"
//     }
//   ];
