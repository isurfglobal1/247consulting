...
import { Scale, Users, FileText, Briefcase, Landmark, Gavel, Cog } from "lucide-react";
      ...
      <div className="container-enterprise relative z-10">
        ...
        >
          ...
          <h2 className="font-heading font-black text-[clamp(2.5rem,5vw,4.5rem)] leading-[1.05] tracking-tight text-white mb-8">
            {t("why.title1", "Why Foreign Companies")} <br /> {t("why.title2", "Choose")} <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-blue to-blue-400">247HR?</span>
          </h2>
          <p className="text-white/60 text-xl font-light max-w-2xl leading-relaxed">
            {t("why.desc", "We eliminate the friction of entering the Ethiopian market by providing an unshakeable operational foundation. Focus on your growth, we'll handle the ground reality.")}
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-auto md:grid-rows-3 gap-6 lg:gap-8">
          ...
          >
            ...
            <div className="relative z-10 mt-auto">
              <h3 className="text-3xl lg:text-5xl font-heading font-black text-white mb-6 leading-[1.1] tracking-tight">
                Understanding Ethiopian <br/>
                <span className="text-primary-blue">labor laws</span>
              </h3>
          ...
          >
            ...
            <div>
              <h3 className="text-2xl font-bold text-white mb-3 tracking-tight">Recruiting reliable local talent</h3>
              <p className="text-white/60 leading-relaxed">
                Access our deeply vetted network of top-tier Ethiopian professionals ready to scale your operations instantly.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-12">
              <h3 className="text-lg font-bold text-white leading-snug tracking-tight mb-2">Managing payroll & statutory requirements</h3>
              <p className="text-sm text-white/50 leading-relaxed line-clamp-3">Automated, error-free compensation structures aligned with taxation rules.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-12">
              <h3 className="text-lg font-bold text-white leading-snug tracking-tight mb-2">Handling contracts & documentation</h3>
              <p className="text-sm text-white/50 leading-relaxed line-clamp-3">Ironclad agreements protecting your enterprise while ensuring local adherence.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              <h3 className="text-2xl font-bold text-white mb-3 tracking-tight">Navigating government compliance</h3>
              <p className="text-white/70 leading-relaxed">
                We handle the bureaucratic friction and regulatory paperwork so you can focus entirely on market execution and operational growth.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-12">
              <h3 className="text-lg font-bold text-white leading-snug tracking-tight mb-2">Workforce disputes & relations</h3>
              <p className="text-sm text-white/50 leading-relaxed line-clamp-3">Proactive mediation and structured HR policies to maintain high performance.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-12 relative z-10">
              <h3 className="text-lg font-bold text-white leading-snug tracking-tight mb-2">Building HR systems from scratch</h3>
              <p className="text-sm text-white/50 leading-relaxed line-clamp-3">Deploying customized enterprise-grade human capital infrastructure.</p>
            </div>
          </motion.div>
